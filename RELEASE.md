...
This document describes the release process for `MRV` app.
...
* Compute the sha256 and md5 checksums of the apk file and attach them as separate files, named MRV-wallet-[version].apk.sha256 and MRV-wallet-[version].apk.md5 respectively, under the 'Assets' section.

### 10. Make sure MRV Wallet is 'Reproducible' in [WalletScrutiny](https://walletscrutiny.com/android/com.mrv.wallet/)

* After apk is uploaded to Google Play make sure that new version of MRV Wallet is 'Reproducible' in WalletScrutiny.